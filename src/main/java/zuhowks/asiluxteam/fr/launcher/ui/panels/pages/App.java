...
import zuhowks.asiluxteam.fr.launcher.ui.panels.pages.content.ContentPanel;
import zuhowks.asiluxteam.fr.launcher.ui.panels.pages.content.Home;
import zuhowks.asiluxteam.fr.launcher.ui.panels.pages.content.Settings;
import zuhowks.asiluxteam.fr.launcher.ui.panels.pages.content.Update;
...
public class App extends Panel {
    ...
    Saver saver = ALauncher.getInstance().getSaver();
    ...
    private void leftBarNav(GridPane pane, Node button) {
        ...
        /* USER AVATAR */
        String avatarUrl = "https://minotar.net/avatar/" + ALauncher.getInstance().getAuthInfos().getUuid() + ".png";
