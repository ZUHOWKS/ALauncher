...
public class Login extends Panel {
    ...
    public Login() {
        ...
        usernameLabel.setFont(Fonts.ARIAL.getFont(17));
        ...
        errorUsernameLabel.setFont(Fonts.ARIAL.getFont(17));
        ...
        passwordLabel.setFont(Fonts.ARIAL.getFont(17));
        ...
        errorPasswordLabel.setFont(Fonts.ARIAL.getFont(17));
        ...
        forgottenPasswordLabel.setFont(Fonts.ARIAL.getFont(14));
        ...
        connectionButton.setFont(Fonts.ARIAL.getFont(20));
        ...
        connectionWithLabel.setFont(Fonts.ARIAL.getFont(18));
